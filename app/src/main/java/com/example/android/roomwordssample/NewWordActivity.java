...
import static com.example.android.roomwordssample.MainActivity.EXTRA_DATA_ID;
import static com.example.android.roomwordssample.MainActivity.EXTRA_DATA_UPDATE_WORD;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            if (!word.isEmpty()) {
                ...
                editWordView.setSelection(word.length());
